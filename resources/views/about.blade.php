...
@section('content')
			<main class="main">
				<section class="promo-primary">
					<picture>
						<source srcset="{{asset('assets/img/about.jpg')}}" media="(min-width: 992px)"/><img class="img--bg lazy" data-src="{{asset('assets/img/about.jpg')}}" alt="img"/>
					</picture>
					...
					<div class="container">
						<div class="row align-items-center">
							<div class="col-lg-6 col-xl-5">
								<div class="img-box"><img class="img--layout lazy" data-src="{{asset('assets/img/about_layout-reverse.png')}}" alt="img"/>
									<div class="img-box__img"><img class="img--bg lazy" data-src="{{asset('assets/img/about-us.jpg')}}" alt="img"/></div>
								</div>
							</div>
